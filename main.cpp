...
int main()
{
    try {
        ...
        if (1) {
            ...
            clas1.insert(std::pair<Classes, int>(FIRST_CLASS, 30));
            clas1.insert(std::pair<Classes, int>(SECOND_CLASS, 100));
            clas2.insert(std::pair<Classes, int>(FIRST_CLASS, 40));
            ...
            Plane *p5 = ex2->addPlane(976, crew2, clas1);
            Plane *p6 = ex2->addPlane(605, crew2, clas2);
            Plane *p7 = ex2->addPlane(604, crew2, clas1);

            Flight *f1 = ex2->addFlight(976, Date("2019-01-25"), "israel", "usa");
          ...
          //  Flight *f6 = ex2->addFlight(604, Date("2019-01-25"), "Poland", "berlin");
            ...
            Reservation *r1 = ex2->addResevation(c2->getID(), f1->getID(), FIRST_CLASS, 2);
